...
if (localStorage.getItem("enable_paragraph_review") === "true") {
  ...
  document$.subscribe(function () {
    ...
    OIWikiFeedbackSysFrontend.setupReview(document.body, {
        apiEndpoint: "https://cloudflare-workers.hikarilan.workers.dev/" // api endpoint injected here, see: scripts/post-build/inject-feedback-sys-frontend/task-handler.ts
      });
  });
}
